...
FIXED_INPUT_SHAPE="--fixed_input_shape=[-1,3,224,224]"
...
# 训练模型压缩文档
TRAIN_ZIP_FILE="${MODEL}_${IMAGE_SIZE}_${TRAIN_EPOCHS}e_${TRAIN_LEARNING_RATE}.tar.gz"
# 量化模型压缩文档
QUANT_ZIP_FILE="${MODEL}_${IMAGE_SIZE}_${QUANT_EPOCHS}e_${QUANT_LEARNING_RATE}_quant.tar.gz"
# 裁剪模型压缩文档
PRUNE_ZIP_FILE="${MODEL}_${IMAGE_SIZE}_${PRUNE_EPOCHS}e_${PRUNE_LEARNING_RATE}_prune.tar.gz"
# 裁剪后量化模型压缩文档
P_Q_ZIP_FILE="${MODEL}_${IMAGE_SIZE}_${P_Q_EPOCHS}e_${P_Q_LEARNING_RATE}_prune_quant.tar.gz"
...
# 训练导出模型压缩文档
TRAIN_INFER_ZIP_FILE="${MODEL}_${IMAGE_SIZE}_${TRAIN_EPOCHS}e_${TRAIN_LEARNING_RATE}_infer.tar.gz"
# 量化导出模型压缩文档
QUANT_INFER_ZIP_FILE="${MODEL}_${IMAGE_SIZE}_${QUANT_EPOCHS}e_${QUANT_LEARNING_RATE}_quant_infer.tar.gz"
# 裁剪导出模型压缩文档
PRUNE_INFER_ZIP_FILE="${MODEL}_${IMAGE_SIZE}_${PRUNE_EPOCHS}e_${PRUNE_LEARNING_RATE}_prune_infer.tar.gz"
# 裁剪后量化导出模型压缩文档
P_Q_INFER_ZIP_FILE="${MODEL}_${IMAGE_SIZE}_${P_Q_EPOCHS}e_${P_Q_LEARNING_RATE}_prune_quant_infer.tar.gz"
